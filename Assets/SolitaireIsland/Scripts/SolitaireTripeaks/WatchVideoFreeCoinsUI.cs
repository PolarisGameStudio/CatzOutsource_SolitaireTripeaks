...
namespace SolitaireTripeaks
{
	public class WatchVideoFreeCoinsUI : MonoBehaviour
	{
		...
		public void TryShow(int level)
		{
			...
			if (GameConfig.Get().HasVideo(level) && IronSourceManager.Instance.IsRewardedVideoAvailable())
			{
				...
				{
					IronSourceManager.Instance.ShowRewardedAds(WatchVideoCompleted);
				});
		...
		private void WatchVideoCompleted()
		{
